...
export const EVALUATION_OPTIONS = [
  {
    ...
    image: '/src/assets/images/translation.png',
  },
  {
    key: 'readability',
    title: '가독성 개선',
    ...
    image: '/src/assets/images/readability.png',
  },
  {
    key: 'redundancy',
    title: '불필요한 반복 제거',
    ...
    image: '/src/assets/images/redundancy.png',
  },
  {
    key: 'logic',
    title: '논리적 비약 보완',
    ...
    revised:
      '"A/B 테스트 결과, 70%의 사용자들이 B안의 단계별 필터링 방식을 더 편리하다고 느꼇는데, 단계별 필터링이 탐색 피로도를 낮추는 데 효과적이었기 때문이다" 라는 내용이 들어간다면 효과적일 것임.',
    image: '/src/assets/images/logic.png',
  },
  {
    key: 'grammar',
    title: '맞춤법 수정',
    ...
    image: '/src/assets/images/grammar.png',
  },
];
